...
unrealRootPath=/home/jaken/ProgramFiles/UnrealEngine-4.24
BattleTanksRootPath=/home/jaken/Documents/Unreal Projects/Battle-Tanks/BattleTanks

gameProjectFile=/home/jaken/Documents/Unreal Projects/Battle-Tanks/BattleTanks/BattleTanks.uproject
...
include(BattleTanksSource.pri)
include(BattleTanksHeader.pri)
include(BattleTanksConfig.pri)
include(BattleTanksIncludes.pri)
include(BattleTanksDefines.pri)

BattleTanks-Linux-Debug.commands = $$build BattleTanks Linux Debug  -project="\"$$gameProjectFile\"" $$args
BattleTanks-Linux-DebugGame.commands = $$build BattleTanks Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BattleTanks-Linux-Shipping.commands = $$build BattleTanks Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BattleTanks-Linux-Test.commands = $$build BattleTanks Linux Test  -project="\"$$gameProjectFile\"" $$args
BattleTanks.commands = $$build BattleTanks Linux Development  -project="\"$$gameProjectFile\"" $$args

BattleTanksEditor-Linux-Debug.commands = $$build BattleTanksEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
BattleTanksEditor-Linux-DebugGame.commands = $$build BattleTanksEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BattleTanksEditor-Linux-Shipping.commands = $$build BattleTanksEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BattleTanksEditor-Linux-Test.commands = $$build BattleTanksEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
BattleTanksEditor.commands = $$build BattleTanksEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	BattleTanks-Linux-DebugGame \
	BattleTanks-Linux-Shipping \
	BattleTanks-Linux-Test \
	BattleTanks \
	BattleTanksEditor-Linux-Debug \
	BattleTanksEditor-Linux-DebugGame \
	BattleTanksEditor-Linux-Shipping \
	BattleTanksEditor-Linux-Test \
	BattleTanksEditor \
